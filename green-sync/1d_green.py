...
SHOP_DOMAIN = os.getenv("SHOPIFY_STORE_DOMAIN_GREEN")
API_VERSION = os.getenv("SHOPIFY_ADMIN_API_VERSION")
ACCESS_TOKEN = os.getenv("SHOPIFY_ADMIN_API_TOKEN_GREEN")
...
def write_to_csv(variants, filename="green_products.csv"):
