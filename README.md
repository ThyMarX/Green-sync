...
There are technically two of the first script, because the project was time sensitive as well as a one time solution, so instead of spending time on optimize the first script to work for both shops, i instead just worked quick and copied it.
